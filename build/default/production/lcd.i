...
# 88 "lcd.c"
  ...
  LCD_WriteMain(0x00);
  LCD_WriteMain(0x06);
  do { unsigned char cmd = 0x08; if ( 1 == 1 ) { cmd |= 1 << 2; } if ( 0 == 1 ) { cmd |= 1 << 1; } if ( 0 == 1 ) { cmd |= 1; } do { LCD_WriteMain( (cmd & 0xF0) >> 4 ); LCD_WriteMain( cmd & 0x0F); } while ( 0 ); } while ( 0 );
  do { LCD_WriteMain( (0x01 & 0xF0) >> 4 ); LCD_WriteMain( 0x01 & 0x0F); } while ( 0 );
}
